...
dhakey = settings.DhaKey
LeysKey = settings.LeysApi
HardiApi = settings.HardiKey
ziyApi = settings.XziyKey
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Leviathan corporation_*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `Botz Whatsapp`, "footerText": "*_© Leviathan corporation_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
key: {
			fromMe: false,
			participant: `447710173736@s.whatsapp.net`, ...(from ? { remoteJid: "447710173736@s.whatsapp.net" } : {})
		},
		message: {
			"productMessage": {
				"product": {
				    ...
				    "businessOwnerJid": `6282280134758@s.whatsapp.net`
		}
	}
}
// TROLI
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            sellerJid: '6282280134758@s.whatsapp.net' 
                          }
                        }
                        }
// LOCATION
...
const fvid = {
	 key: { 
          fromMe: false,
	      participant: `447710173736@s.whatsapp.net`, ...(from ? 
...
const finv = {
	"key": {
		"fromMe": false,
		"participant": "447710173736@s.whatsapp.net",
		"remoteJid": "6282280134758@s.whatsapp.net"
	},
	"message": {
		"groupInviteMessage": {
			"groupJid": "972523040787-1432891551@g.us",
...
"key": {
	  "participant": `447710173736@s.whatsapp.net`,
      "remoteJid": "972523040787-1432891551@g.us",
      "fromMe": false,
...
const fgi = {
	 key: { 
         fromMe: false,
	      participant: `6282280134758@s.whatsapp.net`, ...(from ? 
	 { remoteJid: "972523040787-1432891551@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
...
const daftar2 = ' Cretae by Leviathan corporation'
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Leviathan corporation_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
        ...
        const sendWebp = async(from, url) => {
	        ...
	        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer Leviathan corporation\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} WIB - ${week}`,body:"By Leviathan corporation",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://radhin123.github.io`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_©Leviathan corporation*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
const menuuu = {
    contentText: `${stamtus}`,
    footerText: `Bot by Radhin Al haady, Recod by ${NamaOwner}`,
    buttons: buttons,
    headerType: 1
}
...
//// PEMBATAS MENU STORAGE\\\
 ...
 footerText: 'Leviathan corporation✓',
...
//LUPA
       case 'maker3d': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
                    if (args.length < 1) return reply(`*Example :*\n${prefix + command} Leviathan corporation`)
					teksnya = args.join(" ")
					sticWait(from)
...
footerText: '*_©Leviathan corporation_*',
buttons: gbutsan,
headerType: 4
}
...
const skuygelud = {
    contentText: `${anu}`,
    footerText: '*_©Leviathan corporationz_*',
    buttons: buttons,
    headerType: 1
}
...
"displayName": `Developer Leviathan`,
"contacts": ini_list 
...
⍟ ────────────────── ⍟`
buttons = [
{buttonId:`listmenu`, buttonText: {displayText: 'LIST MENU️'}, type: 1},
{buttonId:`owner`, buttonText: {displayText: 'OWNER BOT'}, type: 1}
]
const scbott = {
    contentText: `${anu}`,
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `Leviathan Botz`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    "hydratedContentText": `Hi ${pushname} 👋,\n\n${jmn} - ${week} ${weton} - ${calender}`,
    "hydratedFooterText": `Leviathan `,
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Leviathan `,
          "url": "https://github.com/radhin123"
        },
        "index": 0
      }
    ]
...
/**alpha.sendMessage(from, md, image, {quoted: flexx, caption: result })**/
...
alpha.sendMessage(from, get_res, image, { /**quoted: flexx,**/ caption: `*©Random ${command}*` })
break
case 'waifu':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
...
if (args.length < 1) return reply('Mau Search Apa om')
sticWait(from)
nyz4 = await getBuffer(`https://hardianto.xyz/api/anime/random?sfw=${command}&apikey=${HardiApi}`)
alpha.sendMessage(from, nyz4, image, {thumbnail:Buffer.alloc(0), caption:`NIH KAK`,quoted: mek})
break
/*]=====> NSFW MENU<=====[
*/
			...
			case 'awoo':
			  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
					...
					anu  = {contextInfo: {"forwardingScore":999,"isForwarded":true,'stanzaId': msgId, 'participant':`0@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"locationMessage": {"degreesLatitude": 41.893714904785156, "degreesLongitude": -87.63370513916016, "name": fake , 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}}
			...
			case 'blowjob2':
			  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
                    ...
                    alpha.sendMessage(from, buffer, image, anu)
					break
			case 'megumin':if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
					/*if (!isNsfw) return reply(lang.nsfwmo())
					reply(lang.wait())*/
...
alpha.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www2.zippyshare.com/d/z9dcY6Nr/791216/%5bNekoPoi%5d_Akina_to_Onsen_de_H_Shiyo%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi2':
qute = fs.readFileSync('./gambar/kagura.jpg') 
alpha.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www4.zippyshare.com/d/j7PFLGUY/946757/%5bNekoPoi%5d_Tsuma_ga_Kirei_ni_Natta_Wake_-_02_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi3':
qute = fs.readFileSync('./gambar/kagura.jpg') 
alpha.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www111.zippyshare.com/d/EK5uqIMh/566060/%5bNekoPoi%5d_Megane_no_Megami_-_01_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi4':
qute = fs.readFileSync('./gambar/kagura.jpg') 
alpha.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www109.zippyshare.com/d/2ebALhhS/463654/%5bNekoPoi%5d_Watashi_ga_Toriko_-_02%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi5':
qute = fs.readFileSync('./gambar/kagura.jpg') 
alpha.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www115.zippyshare.com/d/LmzOkRAI/313299/%5bNekoPoi%5d_Chichi-iro_Toiki_-_01_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi6':
qute = fs.readFileSync('./gambar/kagura.jpg') 
alpha.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www89.zippyshare.com/d/SgEHvrJs/42812/%5bNekoPoi%5d_Chichi-iro_Toiki_-_02_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi7':
qute = fs.readFileSync('./gambar/kagura.jpg') 
alpha.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www66.zippyshare.com/d/j0ivbciL/520411/%5bNekoPoi%5d_Onna_Maou_Melissa_no_H_na_Boukenki_-_01_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi8':
qute = fs.readFileSync('./gambar/kagura.jpg') 
alpha.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www71.zippyshare.com/d/M225YIrR/535656/%5bNekoPoi%5d_Buta_no_Gotoki_Sanzoku_ni_Torawarete_Shojo_wo_Ubawareru_Kyonyuu_Himekishi_Onna_Senshi_-_01%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi9':
qute = fs.readFileSync('./gambar/kagura.jpg') 
alpha.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www49.zippyshare.com/d/bdwYjaXS/605790/%5bNekoPoi%5d_Akebi_no_Hana___Maho_-_01_%5b360P%5d_%5bnekopoi.pro%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
/**break**/
				case 'kalkulator':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Leviathan `}, MessageType.location)
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY Leviathan `)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `Leviathan `, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `Leviathan `, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
